...
pub struct Options {
    ...
    allow_racket_hash_symbols: bool,
}
...
impl Options {
    ...
    pub fn new() -> Self {
        Options {
            ...
            allow_racket_hash_symbols: false,
        }
    }
    ...
    pub fn with_racket_hash_symbols(mut self, allow: bool) -> Self {
        self.allow_racket_hash_symbols = allow;
        self
    }
    ...
    pub fn racket_hash_symbols_allowed(self) -> bool {
        self.allow_racket_hash_symbols
    }
}
        ...
        let token = match peek {
            b'#' => {
                ...
                match self.next_char()? {
                    ...
                    Some(b'%') if self.options.allow_racket_hash_symbols => {
